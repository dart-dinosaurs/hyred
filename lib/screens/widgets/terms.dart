...
// //                 // section("Backups"),
// //                 // content("We perform regular backups of the Content and will do our best to ensure completeness and accuracy of these backups. In the event of the hardware failure or data loss we will restore backups automatically to minimize the impact and downtime."),
// //                 // section("Links to other mobile applications"),
// //                 // content("Although this Mobile Application may link to other mobile applications, we are not, directly or indirectly, implying any approval, association, sponsorship, endorsement, or affiliation with any linked mobile application, unless specifically stated herein. We are not responsible for examining or evaluating, and we do not warrant the offerings of, any businesses or individuals or the content of their mobile applications. We do not assume any responsibility or liability for the actions, products, services, and content of any other third-parties. You should carefully review the legal statements and other conditions of use of any mobile application which you access through a link from this Mobile Application. Your linking to any other off-site mobile applications is at your own risk."),
...
// //                 // section("Changes and amendments"),
...
// //                 // section("Acceptance of these terms"),
...
// //                 // content("If you would like to contact us to understand more about this Agreement or wish to contact us concerning any matter relating to it, you may write a letter to 1265 Military Trail, Toronto, ON."),
// //                 // content("This document was last updated on March 9, 2020"),
// //               ],
// //             ),
// //           ],
// //         )
...
// //     return Container(
// //       padding: const EdgeInsets.fromLTRB(35.0, 16.0, 16.0, 16.0),
// //       child: Text(
// //         content,
// //         style: TextStyle(
// //           fontSize: 14.0,
