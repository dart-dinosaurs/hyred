      ...
      body: ListView(
        children: <Widget>[
          ...
          Padding(
            ...
            infoCard("Personal Information", Icons.account_circle, () {setState(() { _showProfile = true;});}),
            infoCard("Payment Information", Icons.attach_money, (){Router.sailor.navigate("/construction");}),
            infoCard("Notifications", Icons.notifications, (){Router.sailor.navigate("/construction");}),
          Padding(
              padding: const EdgeInsets.all(17.0),
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
          ...
          infoCard("Terms and Conditions", Icons.assignment, (){Router.sailor.navigate("/terms");}),
